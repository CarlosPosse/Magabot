...
#include "imu_mpu6050/imu_raw.h"

const char* FRAME_ID = "imu";
const char* NODE_NAME = "ConvertIMU";
const char* PUB_NAME = "imu_data";
const char* SUB_NAME = "imu_raw";
...
void callback(const imu_mpu6050::imu_raw::ConstPtr& msg)
{
	...
	imu_msg.angular_velocity.x = ((msg->angular_velocity.x / 131) * M_PI) / 180;
	imu_msg.angular_velocity.y = ((msg->angular_velocity.y / 131) * M_PI) / 180;
	imu_msg.angular_velocity.z = ((msg->angular_velocity.z / 131) * M_PI) / 180;

	imu_msg.angular_velocity_covariance[0] = imu_msg.angular_velocity_covariance[4] = imu_msg.angular_velocity_covariance[8] = 0.0000436;
	...
	imu_msg.linear_acceleration_covariance[0] = imu_msg.linear_acceleration_covariance[4] = imu_msg.linear_acceleration_covariance[8] = 0.00392;
